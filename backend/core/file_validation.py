...
from backend.core.validation import sanitize_filename, validate_path_traversal
...
def generate_secure_filename(original_filename: str, user_id: Optional[int] = None) -> str:
    """
...
def validate_image_upload(file: UploadFile, user_id: Optional[int] = None) -> Tuple[Path, str]:
    """
